...
<body>
    ...
    <div>
        <div class="container">
            ...
            <div class="example1">
                <h3 class="h4">Please signup to submit your buisness Idea</h3>
            </div>   
            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-3">
                            <button class="contact100-form-btn" type="submit" name="idea_submit" onclick="clicked();">
        ...
        <div class="container">
            <?php
                ...
                if(isset($_POST['idea_submit'])){
                    ...
                    if(!empty($name) && !empty($email) && !empty($partner_name) && !empty($number) && !empty($address) && !empty($division) && !empty($district) && !empty($education) && !empty($dob) && !empty($idea_title) && !empty($model) && !empty($place) && !empty($amount) && !empty($personal_amount) && !empty($marketing) && !empty($financial) && !empty($support) && !empty($success) && !empty($yourself) && !empty($payment)){
                        $name = mysqli_real_escape_string($connection, $name);
                        $partner_name = mysqli_real_escape_string($connection, $partner_name);
                    ...
                    else if(!empty($name) && !empty($email) && !empty($partner_name) && !empty($number) && !empty($address) && !empty($division) && !empty($district) && !empty($education) && !empty($dob) && !empty($idea_title) && !empty($model) && !empty($place) && !empty($amount) && !empty($personal_amount) && !empty($marketing) && !empty($financial) && !empty($support) && !empty($success) && !empty($yourself) && !empty($payment)){
                        $name = mysqli_real_escape_string($connection, $name);
                        $partner_name = mysqli_real_escape_string($connection, $partner_name);
                        $number = mysqli_real_escape_string($connection, $number);
                        $email = mysqli_real_escape_string($connection, $email);
                        ...
                        $query = "INSERT INTO idea (username, name, partner_name, number, email, address, division, district, education, dob, photo, idea_title, idea_details, model, place, amount, personal_amount, marketing, financial, support, success, training, training_details, program, yourself, payment, send_date ) ";
                        $query .= "VALUES ('{$username}', '{$name}', '{$number}', '{$partner_name}', '{$email}', '{$address}', '{$division}', '{$district}','{$education}','{$dob}', '{$photo}', '{$idea_title}', '{$idea_details}', '{$model}', '{$place}', '{$amount}', '{$personal_amount}', '{$marketing}',  '{$financial}', '{$support}', '{$success}', '{$training}', '{$training_details}', '{$program}', '{$yourself}', '{$payment}', now() )";
                        $contact_query = mysqli_query($connection, $query);
                        ...
                        $query = "INSERT INTO idea (username, name, partner_name, number, email, address, division, district, education, dob, photo, idea_title, idea_details, model, place, amount, personal_amount, marketing, financial, support, success, training, training_details, program, yourself, payment_photo, send_date ) ";
                        $query .= "VALUES ('{$username}', '{$name}', '{$partner_name}', '{$number}', '{$email}', '{$address}', '{$division}', '{$district}','{$education}','{$dob}', '{$photo}', '{$idea_title}', '{$idea_details}', '{$model}', '{$place}', '{$amount}', '{$personal_amount}', '{$marketing}',  '{$financial}', '{$support}', '{$success}', '{$training}', '{$training_details}', '{$program}', '{$yourself}', '{$payment_photo}', now() )";
                        $contact_query = mysqli_query($connection, $query);
                        ...
                        $query = "INSERT INTO idea (username, name, number, email, address, division, district, education, dob, photo, idea_title, idea_details, model, place, amount, personal_amount, marketing, financial, support, success, training, training_details, program, yourself, payment_photo, send_date ) ";
                        $query .= "VALUES ('{$username}', '{$name}', '{$number}', '{$email}', '{$address}', '{$division}', '{$district}','{$education}','{$dob}', '{$photo}', '{$idea_title}', '{$idea_details}', '{$model}', '{$place}', '{$amount}', '{$personal_amount}', '{$marketing}',  '{$financial}', '{$support}', '{$success}', '{$training}', '{$training_details}', '{$program}', '{$yourself}', '{$payment_photo}', now() )";
                        $contact_query = mysqli_query($connection, $query);
                        ...
                        $query = "INSERT INTO idea (username, name, number, email, address, division, district, education, dob, photo, idea_title, idea_details, model, place, amount, personal_amount, marketing, financial, support, success, training, training_details, program, yourself, payment,  send_date ) ";
                        $query .= "VALUES ('{$username}', '{$name}', '{$number}', '{$email}', '{$address}', '{$division}', '{$district}','{$education}','{$dob}', '{$photo}', '{$idea_title}', '{$idea_details}', '{$model}', '{$place}', '{$amount}', '{$personal_amount}', '{$marketing}',  '{$financial}', '{$support}', '{$success}', '{$training}', '{$training_details}', '{$program}', '{$yourself}', '{$payment}', now() )";
                        $contact_query = mysqli_query($connection, $query);
            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Phone is required">
                            <span class="label-input100">Contact No:</span>
                            <input class="input100" type="number" name="number" placeholder="Enter phone number" required>
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-contact100">
                            <label class="label-input100">Title of the Idea	: *</label>
                            <div class="wrap-input100 rs1 validate-input">
                                <input class="input100" type="text" name="idea_title" placeholder="" required>					
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        ...
                        <label class="label-input100" for="email">Share the idea in brief:</label>
                        <div class="wrap-input100 validate-input">
                            <textarea id="message" class="input100" name="idea_details" placeholder="" required></textarea>
                            <span class="focus-input100"></span>
                        </div>

                        <label class="label-input100">Have you developed the business model:</label>
                        <div class="wrap-input100 rs1 validate-input">
                            <input class="input100" type="text" name="model" placeholder="" required>					
                            <span class="focus-input100"></span>
                        </div>

                        <label class="label-input100">Where the business will be established:</label>
                        <div class="wrap-input100 rs1 validate-input">
                            <input class="input100" type="text" name="place" placeholder="" required>					
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <label class="label-input100">How much will you invest as equity?</label>
                        <div class="wrap-input100 rs1 validate-input">
                            <input class="input100" type="text" name="personal_amount" placeholder="" required>					
                            <span class="focus-input100"></span>
                        </div>

                        <label class="label-input100" for="message">Share your marketing plan (Customers, How to reach them?):</label>
                        <div class="wrap-input100 validate-input">
                            <textarea id="message" class="input100" name="marketing" placeholder="" required></textarea>
                            <span class="focus-input100"></span>
                        </div>

                        <label class="label-input100" for="message">Share your financial plan (Source of Fund and Revenue):</label>
                        <div class="wrap-input100 validate-input">
                            <textarea id="message" class="input100" name="financial" placeholder="" required></textarea>
                            <span class="focus-input100"></span>
                        </div>

                        <label class="label-input100" for="message">What support you need to start the business:</label>
                        <div class="wrap-input100 validate-input">
                            <textarea id="message" class="input100" name="support" placeholder="" required></textarea>
                            <span class="focus-input100"></span>
                        </div>

                        <label class="label-input100" for="message">Why do you think you will be successful in this business, give 5 reasons:</label>
                        <div class="wrap-input100 validate-input">
                            <textarea id="message" class="input100" name="success" placeholder="" required></textarea>
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <label class="label-input100" for="message">Tell us about you:</label>
                        <div class="wrap-input100 validate-input">
                            <textarea id="message" class="input100" name="yourself" placeholder="" required></textarea>
                            <span class="focus-input100"></span>
                        </div>
