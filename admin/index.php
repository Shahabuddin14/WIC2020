...
<head>
    ...
    <title>WIC 2020 | Admin login</title>
...
<body>
    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <a class="brand" href="">WIC 2020 | Admin</a>

                <div class="nav-collapse collapse navbar-inverse-collapse">
                    <ul class="nav pull-right">
                        <li><a href="http://localhost/furnitrend/">Website</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="footer">
        <div class="container">
            <b class="copyright">&copy; WIC 2020 </b> All rights reserved.
        </div>
    </div>
